...
void state_machine() { //la lógica de lo que hace cada estado (cambiar el display, led, servo, etc.) puede estar acá adentro o en funciones que se llaman acá o en get_event().
  switch(state)
  {
    case INIT:
      ...
      //DISPLAY LIMPIO
      lcd.clear();
      lcd.setCursor(1,0);//centro el texto
      lcd.print("ESTADO: LIMPIO");
    break;
    case LIMPIO:
      switch(event)
      {
        case ENTRANCE_DETECTED:
          ...
          //DISPLAY GATO DENTRO
          lcd.clear();
          lcd.setCursor(2,0);//centro el texto
          lcd.print("GATO  DENTRO");
          lcd.setCursor(2,1);//centro el texto
        ...
        case BUTTON_1_ACTIVATED:
          ...
          //DISPLAY VACIANDO
          lcd.clear();
          lcd.setCursor(4,0);//centro el texto
          lcd.print("VACIANDO");
          lcd.setCursor(2,1);//centro el texto
          lcd.print("Sensors: OFF");
          //comienza a ignorar los sensores,trabar la puerta.
        break;
        case CONTINUE:
    ...
    case ENTRANDO_GATO:
      ...
      switch(event)
      {
        case EXIT_DETECTED:
          state = GATO_AFUERA;
          //DISPLAY CALCULANDO
          lcd.setCursor(0,0);//centro el texto
          lcd.print("CALCULANDO .....");
          lcd.setCursor(0,1);//centro el texto
    ...
    case LEVEMENTE_SUCIA: 
      switch(event)
      {
        ...
        case BUTTON_1_ACTIVATED:
          ...
          lcd.setCursor(2,1);//centro el texto
          lcd.print("NO  MOLESTAR");
          //comienza a ignorar los sensores, mueve el SERVO.
        break;
