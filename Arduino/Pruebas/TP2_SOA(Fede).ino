...
void get_event()
{
  /*Serial.print("Dist: ");Serial.print(verify_distance());
  Serial.print("Boton: ");Serial.print(verify_button());
  Serial.print("Moisture: ");Serial.println(verify_moisture());*/
...
bool verify_distance()
{
  time_to_object = distance_read(DISTANCE_SENSOR_TRIGGER, DISTANCE_SENSOR_ECHO);
...
bool verify_button()
{
  ...
  Serial.print("Button: "); Serial.println(button_state);
...
{
  distance_state = DISTANCE_OUTSIDE;
  pinMode(DISTANCE_SENSOR_ECHO, OUTPUT);
  pinMode(DISTANCE_SENSOR_TRIGGER, INPUT);
